...
jQuery(function ($) {
  ...
  function hashCode (t) {
    for (var n = 0, r = 0; r < t.length; r++) n = t.charCodeAt(r) + ((n << 5) - n)
    return n
  }
    ...
    ft_relayhoststable = FooTable.init('#relayhoststable', {
      'columns': [
        ...
        },
        {
          ...
          'filterable': false,
          'sortable': false,
          'style': { 'text-align': 'right', 'maxWidth': '220px', 'width': '220px' },
          'type': 'html',
          'title': lang.action,
          'breakpoints': 'xs sm md'
        }
  ...
  function draw_queue () {
    ft_queuetable = FooTable.init('#queuetable', {
      'columns': [
        ...
        {
          'name': 'arrival_time', 'sorted': true, 'direction': 'DESC', 'formatter': function unix_time_format (tm) {
            var date = new Date(tm ? tm * 1000 : 0)
            return date.toLocaleString()
          }, 'title': lang.arrival_time, 'style': { 'width': '170px' }
        },
        {
          'name': 'message_size',
