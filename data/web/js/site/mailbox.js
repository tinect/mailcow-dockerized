...
jQuery(function ($) {
  ...
  function humanFileSize (i) {
    ...
    var B = ['KiB', 'MiB', 'GiB', 'TiB', 'PiB', 'EiB', 'ZiB', 'YiB'], e = -1
    do {
      i /= 1024, ++e
  ...
  function draw_domain_table () {
    ft_domain_table = FooTable.init('#domain_table', {
      'columns': [
        ...
        {
          'name': 'def_quota_for_mbox',
          'title': lang.mailbox_defquota,
          'breakpoints': 'xs sm md',
          'style': { 'width': '125px' }
        },
        {
          'name': 'max_quota_for_mbox',
        ...
        },
        {
          ...
          'filterable': false,
          'sortable': false,
          'style': { 'text-align': 'right', 'maxWidth': '240px', 'width': '240px' },
          'type': 'html',
          'title': lang.action,
          'breakpoints': 'xs sm md'
        }
    ...
    ft_mailbox_table = FooTable.init('#mailbox_table', {
      'columns': [
        ...
        },
        {
          'sorted': true,
          'name': 'username',
          'style': { 'word-break': 'break-all', 'min-width': '120px' },
          'title': lang.username
        },
        {
          'name': 'name',
        ...
        { 'name': 'active', 'filterable': false, 'title': lang.active },
        {
          ...
          'filterable': false,
          'sortable': false,
          'style': { 'min-width': '290px', 'text-align': 'right' },
          'type': 'html',
          'title': lang.action,
          'breakpoints': 'xs sm md'
        }
    ...
    ft_resource_table = FooTable.init('#resource_table', {
      'columns': [
        ...
        { 'name': 'domain', 'title': lang.domain, 'breakpoints': 'xs sm' },
        {
          ...
          'filterable': false,
          'style': { 'maxWidth': '150px', 'width': '140px' },
        ...
        },
        {
          ...
          'filterable': false,
          'sortable': false,
          'style': { 'text-align': 'right', 'maxWidth': '180px', 'width': '180px' },
          'type': 'html',
          'title': lang.action,
          'breakpoints': 'xs sm'
        }
    ...
    ft_bcc_table = FooTable.init('#bcc_table', {
      'columns': [
        ...
        },
        {
          ...
          'name': 'id',
          'title': 'ID',
          'style': { 'maxWidth': '60px', 'width': '60px', 'text-align': 'center' }
        },
    ...
    ft_alias_table = FooTable.init('#alias_table', {
      'columns': [
        ...
        { 'name': 'sogo_visible', 'title': lang.sogo_visible, 'breakpoints': 'all' },
        {
          'name': 'active',
          'filterable': false,
          'style': { 'maxWidth': '50px', 'width': '70px' },
          'title': lang.active
        },
        {
          'name': 'action',
    ...
    ft_aliasdomain_table = FooTable.init('#aliasdomain_table', {
      'columns': [
        ...
        },
        {
          ...
          'filterable': false,
          'sortable': false,
          'style': { 'text-align': 'right', 'maxWidth': '250px', 'width': '250px' },
          'type': 'html',
          'title': lang.action,
          'breakpoints': 'xs sm'
        }
